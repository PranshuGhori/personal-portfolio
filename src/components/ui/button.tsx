...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-electric-blue text-slate-950 hover:bg-electric-blue/90 hover:shadow-[0_0_15px_rgba(0,240,255,0.4)]",
        primary: "bg-gradient-to-r from-electric-blue to-violet text-white hover:opacity-90 hover:shadow-[0_0_20px_rgba(139,92,246,0.5)]",
        ...
        glass: "glass hover:bg-white/10 border-white/10 text-white",
      },
      size: {
